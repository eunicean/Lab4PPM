...
fun LoginLayout(navController: NavController){
    ...
    Column(
        ...
        cickText(text = "Register", navController = navController, route = AppScreens.RegisterScreen.route, red = 224, green = 122, blue = 95)
    }
}


@Composable
fun cickText(text:String, navController: NavController, route: String, red: Int, green: Int, blue: Int){
    Text(text = text,
